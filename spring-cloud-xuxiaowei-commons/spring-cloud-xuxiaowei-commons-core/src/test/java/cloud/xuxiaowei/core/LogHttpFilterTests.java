...
import cloud.xuxiaowei.core.config.ResourceServerConfig;
 ...
 */
@Slf4j
@SpringBootTest(classes = { SpringCloudXuxiaoweiCommonsCoreApplication.class, ResourceServerConfig.class },
